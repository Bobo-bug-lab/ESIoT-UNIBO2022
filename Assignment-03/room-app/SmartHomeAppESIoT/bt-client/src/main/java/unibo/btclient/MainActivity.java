...
public class MainActivity extends AppCompatActivity {
    ...
    private void initUI() {
        ...
        SeekBar rollerBlindsControl = (SeekBar) findViewById(R.id.rollerBlindsControl);
        rollerBlindsControl.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
            @Override
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                ...
                String message = String.format("aR%03d", progress);
                btChannel.sendMessage(message);
            }
        });

        Switch ledSwitch = (Switch) findViewById(R.id.ledSwitch);
        ledSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                String message = String.format("aL%d", isChecked ? 1 : 0);
                btChannel.sendMessage(message);
            }
        });
    }
