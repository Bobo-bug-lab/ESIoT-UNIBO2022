...
static char* getTelemetryPayload()
{
  ...
  // 拷贝detect_status值
  temp_span = az_span_copy(temp_span, AZ_SPAN_FROM_STR(", \"detect_status\": "));
  (void)az_span_i32toa(temp_span, detect, &temp_span);

  // 拷贝light_value值
  temp_span = az_span_copy(temp_span, AZ_SPAN_FROM_STR(", \"light_value\": "));
  (void)az_span_i32toa(temp_span, light_value, &temp_span);
